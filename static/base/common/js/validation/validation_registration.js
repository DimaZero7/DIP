...
var NikValidityChecks = [
    {
        isInvalid: function (input) {
            return input.value.length < 3;
        },
        invalidityMessage: 'Вы ввели меньше чем 3 символа',
        element: document.querySelector('label[for="nik"] .input-requirements li:nth-child(1)')
    },
     {
        isInvalid: function (input) {
        ...
        element: document.querySelector('label[for="nik"] .input-requirements li:nth-child(2)')
    }
];
...
var mailValidityChecks = [
	...
	},
    {
        ...
        invalidityMessage: 'Поле должно содержать символ @',
...
var passwordRepeatValidityChecks = [
    {
        ...
        invalidityMessage: 'Пароль должен совпадать',
	}
];
...
NikInput.CustomValidation = new CustomValidation(NikInput);
NikInput.CustomValidation.validityChecks = NikValidityChecks;
